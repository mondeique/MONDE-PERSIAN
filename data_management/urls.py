...
urlpatterns = [
    ...
    path('api/coverlabeling/<int:cropped_image_id>', CoverLabelingRetrieveAPIView.as_view()),
    ...
    path('api/coverlabel/<int:cropped_image_id>', CoverLabelCreateUpdateAPI.as_view()),
    ...
    path('api/speedshapelabeling/<int:cropped_image_id'), SpeedyShapeLabelingRetrieveAPIView(),
    ...
    # path('api/speedpatternlabeling/<int:cropped_image_id'), SpeedyPatternLabelingRetrieveAPIView(),
